...
function About() {
  ...
  return (
      ...
      <div className="flex flex-col gap-16">
        <div>
          <h1 className="text-7xl mb-4 text-white" style={{ fontFamily: 'cursive' }}>About Me</h1>
        ...
        <div className="flex justify-between">
          ...
          <p className="text-xl max-w-xl text-white" style={{ fontFamily: 'cursive' }}>
        ...
        <div className='text-5xl mb-8'>Skills</div>
