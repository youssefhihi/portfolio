...
const Contact = () => {
  ...
  return (
    ...
    <div className={`w-full mt-24 px-32 bg-black text-white f ${loading ? 'blur-xl	' : ''}`}>
    <ToastContainer />
    <div>
          <h1 className="text-7xl mb-4 text-white" style={{ fontFamily: 'cursive' }}>Contact Me</h1>
    ...
    <div className='flex flex-col gap-16 w-1/2'>
      ...
      I am always excited to connect with new people and explore opportunities for collaboration. Whether you have a project idea, need assistance with development, or just want to chat about technology and innovations, feel free to reach me. Let's create something amazing together!
       ...
       <div class="form-card1 w-1/2">
       <div class="form-card2">
      <form class="form " onSubmit={handleSubmit}>
      <p class="form-heading">Get In Touch</p>

      <div class="form-field">
        <input required="" name='name' placeholder="Name" class="input-field" type="text" />
        <ValidationError 
        prefix="Name" 
        field="name"
        errors={state.errors}
